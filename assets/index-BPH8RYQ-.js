(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=(e,t)=>t.some(t=>e instanceof t),t,n;function r(){return t||=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction]}function i(){return n||=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey]}var a=new WeakMap,o=new WeakMap,s=new WeakMap;function c(e){let t=new Promise((t,n)=>{let r=()=>{e.removeEventListener(`success`,i),e.removeEventListener(`error`,a)},i=()=>{t(d(e.result)),r()},a=()=>{n(e.error),r()};e.addEventListener(`success`,i),e.addEventListener(`error`,a)});return s.set(t,e),t}function l(e){if(a.has(e))return;let t=new Promise((t,n)=>{let r=()=>{e.removeEventListener(`complete`,i),e.removeEventListener(`error`,a),e.removeEventListener(`abort`,a)},i=()=>{t(),r()},a=()=>{n(e.error||new DOMException(`AbortError`,`AbortError`)),r()};e.addEventListener(`complete`,i),e.addEventListener(`error`,a),e.addEventListener(`abort`,a)});a.set(e,t)}var u={get(e,t,n){if(e instanceof IDBTransaction){if(t===`done`)return a.get(e);if(t===`store`)return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return d(e[t])},set(e,t,n){return e[t]=n,!0},has(e,t){return e instanceof IDBTransaction&&(t===`done`||t===`store`)||t in e}};function ee(e){u=e(u)}function te(e){return i().includes(e)?function(...t){return e.apply(f(this),t),d(this.request)}:function(...t){return d(e.apply(f(this),t))}}function ne(t){return typeof t==`function`?te(t):(t instanceof IDBTransaction&&l(t),e(t,r())?new Proxy(t,u):t)}function d(e){if(e instanceof IDBRequest)return c(e);if(o.has(e))return o.get(e);let t=ne(e);return t!==e&&(o.set(e,t),s.set(t,e)),t}var f=e=>s.get(e);function re(e,t,{blocked:n,upgrade:r,blocking:i,terminated:a}={}){let o=indexedDB.open(e,t),s=d(o);return r&&o.addEventListener(`upgradeneeded`,e=>{r(d(o.result),e.oldVersion,e.newVersion,d(o.transaction),e)}),n&&o.addEventListener(`blocked`,e=>n(e.oldVersion,e.newVersion,e)),s.then(e=>{a&&e.addEventListener(`close`,()=>a()),i&&e.addEventListener(`versionchange`,e=>i(e.oldVersion,e.newVersion,e))}).catch(()=>{}),s}var ie=[`get`,`getKey`,`getAll`,`getAllKeys`,`count`],ae=[`put`,`add`,`delete`,`clear`],p=new Map;function oe(e,t){if(!(e instanceof IDBDatabase&&!(t in e)&&typeof t==`string`))return;if(p.get(t))return p.get(t);let n=t.replace(/FromIndex$/,``),r=t!==n,i=ae.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(i||ie.includes(n)))return;let a=async function(e,...t){let a=this.transaction(e,i?`readwrite`:`readonly`),o=a.store;return r&&(o=o.index(t.shift())),(await Promise.all([o[n](...t),i&&a.done]))[0]};return p.set(t,a),a}ee(e=>({...e,get:(t,n,r)=>oe(t,n)||e.get(t,n,r),has:(t,n)=>!!oe(t,n)||e.has(t,n)}));var se=[`continue`,`continuePrimaryKey`,`advance`],ce={},m=new WeakMap,le=new WeakMap,ue={get(e,t){if(!se.includes(t))return e[t];let n=ce[t];return n||=ce[t]=function(...e){m.set(this,le.get(this)[t](...e))},n}};async function*de(...e){let t=this;if(t instanceof IDBCursor||(t=await t.openCursor(...e)),!t)return;t=t;let n=new Proxy(t,ue);for(le.set(n,t),s.set(n,f(t));t;)yield n,t=await(m.get(n)||t.continue()),m.delete(n)}function fe(t,n){return n===Symbol.asyncIterator&&e(t,[IDBIndex,IDBObjectStore,IDBCursor])||n===`iterate`&&e(t,[IDBIndex,IDBObjectStore])}ee(e=>({...e,get(t,n,r){return fe(t,n)?de:e.get(t,n,r)},has(t,n){return fe(t,n)||e.has(t,n)}}));var pe=`finanzas-personales`,me=3,he;function h(){return he||=re(pe,me,{upgrade(e){if(e.objectStoreNames.contains(`configuracion`)||e.createObjectStore(`configuracion`,{keyPath:`id`}),e.objectStoreNames.contains(`categorias`)||e.createObjectStore(`categorias`,{keyPath:`id`}),e.objectStoreNames.contains(`bolsillos`)||e.createObjectStore(`bolsillos`,{keyPath:`id`}),!e.objectStoreNames.contains(`transacciones`)){let t=e.createObjectStore(`transacciones`,{keyPath:`id`});t.createIndex(`porFecha`,`fecha`),t.createIndex(`porOrigen`,`origenId`)}e.objectStoreNames.contains(`ciclos`)||e.createObjectStore(`ciclos`,{keyPath:`id`}),e.objectStoreNames.contains(`cierresSemana`)||e.createObjectStore(`cierresSemana`,{keyPath:`id`}),e.objectStoreNames.contains(`metas`)||e.createObjectStore(`metas`,{keyPath:`id`})}}),he}function g(){return crypto.randomUUID()}function _(){return v(new Date)}function v(e){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function y(e){let[t,n,r]=e.split(`-`).map(Number);return new Date(t,n-1,r)}function b(e,t){let n=y(e),r=y(t);return Math.round((r.getTime()-n.getTime())/864e5)}function x(e,t){let n=y(e);return n.setDate(n.getDate()+t),v(n)}function ge(e,t){let n=y(e),r=n.getDate();return n.setMonth(n.getMonth()+t),n.getDate()!==r&&n.setDate(0),v(n)}function S(e){let t=y(e);return`${String(t.getDate()).padStart(2,`0`)}/${String(t.getMonth()+1).padStart(2,`0`)}/${t.getFullYear()}`}var _e=[{nombre:`Internet`,monto:25,tipo:`fija`},{nombre:`Suscripción Claude`,monto:20,tipo:`fija`},{nombre:`Pasajes / transporte`,monto:20,tipo:`variable`},{nombre:`Comida`,monto:150,tipo:`variable`},{nombre:`Almuerzos en el trabajo`,monto:60,tipo:`variable`}],ve=[{id:`ahorro`,nombre:`Ahorro`,monto:200,acumula:!0,saldoAcumulado:0},{id:`imprevistos`,nombre:`Imprevistos`,monto:60,acumula:!0,saldoAcumulado:0},{id:`gustos`,nombre:`Gustos`,monto:50,acumula:!1,saldoAcumulado:0},{id:`reserva`,nombre:`Reserva`,monto:15,acumula:!0,saldoAcumulado:0}],ye=[`configuracion`,`categorias`,`bolsillos`,`transacciones`,`ciclos`,`cierresSemana`,`metas`];async function be(e){let t=e.transaction([`configuracion`,`categorias`,`bolsillos`],`readwrite`);await t.objectStore(`configuracion`).put({id:`principal`,ingresoMensual:600,diaCobroEsperado:12,umbralHormiga:5,fechaPrimerUso:_()});for(let e of _e)await t.objectStore(`categorias`).put({id:g(),...e});for(let e of ve)await t.objectStore(`bolsillos`).put(e);await t.done}async function xe(){let e=await h();await e.get(`configuracion`,`principal`)||await be(e)}async function Se(){let e=await h(),t=e.transaction(ye,`readwrite`);for(let e of ye)await t.objectStore(e).clear();await t.done,await be(e)}function C(e){let t=Number.isFinite(e)?e:0,n=t.toFixed(2).split(`.`),r=n[0].replace(`-`,``),i=n[1],a=r.replace(/\B(?=(\d{3})+(?!\d))/g,`.`);return`${t<0?`-`:``}$${a},${i}`}function w(e){return Math.round((e+2**-52)*100)/100}var Ce=[`ahorro`,`imprevistos`,`gustos`,`reserva`];async function T(){return(await(await h()).getAll(`bolsillos`)).sort((e,t)=>Ce.indexOf(e.id)-Ce.indexOf(t.id))}async function we(e){return(await h()).get(`bolsillos`,e)}async function Te(e,t){let n=await h(),r=await n.get(`bolsillos`,e);if(!r)throw Error(`El bolsillo no existe`);let i={...r,monto:t};return await n.put(`bolsillos`,i),i}async function Ee(e,t){let n=await h(),r=await n.get(`bolsillos`,e);if(!r)throw Error(`El bolsillo no existe`);let i={...r,saldoAcumulado:w(r.saldoAcumulado+t)};return await n.put(`bolsillos`,i),i}async function E(){return(await(await h()).getAll(`ciclos`)).find(e=>e.fechaFin===null)||null}async function De(){return await E()===null}async function Oe(){return(await(await h()).getAll(`ciclos`)).sort((e,t)=>e.fechaInicio<t.fechaInicio?1:-1)}async function ke(e){let t=await h(),n=await E();if(n){let r=x(e,-1);await t.put(`ciclos`,{...n,fechaFin:r})}let r={id:g(),fechaInicio:e,fechaFin:null};await t.put(`ciclos`,r);let i=await T();for(let e of i)e.acumula&&await Ee(e.id,e.monto);return r}async function D(){return(await h()).get(`configuracion`,`principal`)}async function Ae(e){let t=await h(),n={...await t.get(`configuracion`,`principal`),...e};return await t.put(`configuracion`,n),n}async function O(){return(await(await h()).getAll(`categorias`)).sort((e,t)=>e.nombre.localeCompare(t.nombre,`es`))}async function je(e){let t=await h(),n={id:g(),...e};return await t.put(`categorias`,n),n}async function Me(e,t){let n=await h(),r=await n.get(`categorias`,e);if(!r)throw Error(`La categoría no existe`);let i={...r,...t};return await n.put(`categorias`,i),i}async function Ne(e){await(await h()).delete(`categorias`,e)}async function k(){return(await O()).reduce((e,t)=>e+t.monto,0)}async function A(e,t){if(!e||e.origenTipo!==`bolsillo`)return;let n=await we(e.origenId);n&&n.acumula&&await Ee(n.id,t*e.monto)}async function Pe(e){if(!e.origenTipo||!e.origenId)throw Error(`Toda transacción necesita un origen (categoría o bolsillo)`);if(!(e.monto>0))throw Error(`El monto debe ser mayor a cero`);if(e.origenTipo===`bolsillo`&&e.origenId===`ahorro`&&!e.confirmoRetiroAhorro)throw Error(`Un retiro de Ahorro necesita confirmación explícita`);let t={id:g(),fecha:e.fecha||_(),monto:w(e.monto),nota:e.nota||``,origenTipo:e.origenTipo,origenId:e.origenId,creadoEn:Date.now()};return await(await h()).put(`transacciones`,t),await A(t,-1),t}async function Fe(e,t){let n=await h(),r=await n.get(`transacciones`,e);if(!r)throw Error(`La transacción no existe`);let i={...r,...t};return t.monto!==void 0&&(i.monto=w(t.monto)),await A(r,1),await n.put(`transacciones`,i),await A(i,-1),i}async function Ie(e){let t=await h(),n=await t.get(`transacciones`,e);await t.delete(`transacciones`,e),await A(n,1)}async function j(e={}){let t=await(await h()).getAll(`transacciones`);return e.desde&&(t=t.filter(t=>t.fecha>=e.desde)),e.hasta&&(t=t.filter(t=>t.fecha<=e.hasta)),e.origenId&&(t=t.filter(t=>t.origenId===e.origenId)),t.sort((e,t)=>e.fecha===t.fecha?t.creadoEn-e.creadoEn:e.fecha<t.fecha?1:-1)}async function M(e,t,n){return w((await j({origenId:e,desde:t,hasta:n})).reduce((e,t)=>e+t.monto,0))}async function Le(){let e=await E();return e?{inicio:e.fechaInicio,fin:_(),enModoSeguimiento:!1,ciclo:e}:{inicio:(await D()).fechaPrimerUso,fin:_(),enModoSeguimiento:!0,ciclo:null}}async function Re(){let{inicio:e,fin:t,enModoSeguimiento:n}=await Le(),[r,i,a]=await Promise.all([O(),T(),j({desde:e,hasta:t})]),o=e=>w(a.filter(t=>t.origenId===e).reduce((e,t)=>e+t.monto,0));return{categorias:r.map(e=>({tipo:`categoria`,id:e.id,nombre:e.nombre,monto:e.monto,tipoGasto:e.tipo,gastado:o(e.id)})),bolsillos:i.map(e=>({tipo:`bolsillo`,id:e.id,nombre:e.nombre,monto:e.monto,acumula:e.acumula,saldoAcumulado:e.saldoAcumulado,gastado:o(e.id)})),inicio:e,fin:t,enModoSeguimiento:n}}function ze(e,t,n){return`${e}__${t}__${n}`}async function Be(e,t,n){return(await h()).get(`cierresSemana`,ze(e,t,n))}async function Ve(e){let t=await h(),n={id:ze(e.cicloId,e.origenId,e.semanaNumero),...e};return await t.put(`cierresSemana`,n),n}async function He(e,t,n){let r=await Be(e,t,n);return r&&r.decision===`siguienteSemana`?r.sobrante:0}function Ue(e){return x(ge(e,1),-1)}function We(e,t){let n=b(e,t)+1,r=Math.max(1,Math.ceil(n/7)),i=[];for(let n=0;n<r;n++){let r=x(e,n*7),a=x(r,6),o=a>t?t:a,s=b(r,o)+1;i.push({numero:n+1,inicio:r,fin:o,dias:s})}return i}function Ge(e,t){return e.find(e=>t>=e.inicio&&t<=e.fin)||(t<e[0].inicio?e[0]:e[e.length-1])}function Ke(e,t,n){return n<=0?0:w(e*t.dias/n)}var qe=90,Je=75,Ye=20;function N({presupuesto:e,gastado:t,diasTranscurridos:n,diasTotales:r}){let i=w(e-t),a=Math.max(r-n,0);if(e<=0)return{estado:t>0?`pasado`:`verde`,restante:i,diasRestantes:a,montoPorDia:i,porcentajeGastado:t>0?100:0,porcentajeTiempo:0};let o=t/e*100,s=r>0?n/r*100:100,c=a>0?w(i/a):i,l;return l=t>=e?`pasado`:o>=qe?`rojo`:o>=Je||o-s>Ye?`amarillo`:`verde`,{estado:l,restante:i,diasRestantes:a,montoPorDia:c,porcentajeGastado:o,porcentajeTiempo:s}}function P(e,t){let{estado:n,restante:r,diasRestantes:i,montoPorDia:a}=t,o=`${i} día${i===1?``:`s`}`;return n===`pasado`?`Te excediste en ${e} por ${C(Math.abs(r))}. Puedes cubrirlo con Gustos, Reserva o Imprevistos — nunca con tu Ahorro sin confirmarlo antes.`:n===`rojo`?`Cuidado con ${e}: te quedan ${C(r)} para ${o} (~${C(a)}/día). Frena el resto del período.`:n===`amarillo`?`Vas rápido en ${e}: te quedan ${C(r)} para ${o} (~${C(a)}/día).`:`Vas bien en ${e}: te quedan ${C(r)} para ${o}.`}var F=`gustos`;async function I(){let e=await E();if(!e)return null;let t=_(),n=e.fechaFin||Ue(e.fechaInicio),r=b(e.fechaInicio,n)+1,i=We(e.fechaInicio,n);return{ciclo:e,fechaFin:n,totalDias:r,semanas:i,semanaActual:Ge(i,t),hoy:t}}async function Xe(e,t){let{ciclo:n,totalDias:r,semanaActual:i}=t,[a,o]=await Promise.all([M(e.id,i.inicio,i.fin),i.numero>1?He(n.id,e.id,i.numero-1):Promise.resolve(0)]),s=w(Ke(e.monto,i,r)+o),c=N({presupuesto:s,gastado:a,diasTranscurridos:Math.min(Math.max(b(i.inicio,t.hoy)+1,0),i.dias),diasTotales:i.dias});return{...c,presupuesto:s,gastado:a,mensaje:P(e.nombre,c)}}async function Ze(e,t){let{ciclo:n,totalDias:r,hoy:i}=t,a=await M(e.id,n.fechaInicio,i),o=Math.min(Math.max(b(n.fechaInicio,i)+1,0),r),s=N({presupuesto:e.monto,gastado:a,diasTranscurridos:o,diasTotales:r});return{...s,presupuesto:e.monto,gastado:a,mensaje:P(e.nombre,s)}}async function Qe(){let e=await I(),[t,n]=await Promise.all([O(),T()]);if(!e)return{enModoSeguimiento:!0,infoCiclo:null,conSemaforo:[],sinSemaforo:{categorias:t,bolsillos:n}};let r=t.filter(e=>e.tipo===`fija`),i=t.filter(e=>e.tipo===`variable`),a=n.find(e=>e.id===F),o=n.filter(e=>e.id!==F);return{enModoSeguimiento:!1,infoCiclo:e,conSemaforo:await Promise.all([...i.map(async t=>({tipo:`categoria`,id:t.id,nombre:t.nombre,periodo:`semana`,...await Xe(t,e)})),(async()=>({tipo:`bolsillo`,id:a.id,nombre:a.nombre,periodo:`mes`,...await Ze(a,e)}))()]),sinSemaforo:{categoriasFijas:r,otrosBolsillos:o}}}async function $e(e,t,n){let r=await I();if(!r)return null;if(e===`bolsillo`&&t===F){let e=(await T()).find(e=>e.id===F),t=await Ze(e,r);return et(e.nombre,t,n,r.totalDias,r.totalDias)}if(e===`categoria`){let e=(await O()).find(e=>e.id===t);if(!e||e.tipo!==`variable`)return null;let i=await Xe(e,r),a=Math.min(Math.max(b(r.semanaActual.inicio,r.hoy)+1,0),r.semanaActual.dias);return et(e.nombre,i,n,a,r.semanaActual.dias)}return null}function et(e,t,n,r,i){let a=N({presupuesto:t.presupuesto,gastado:w(t.gastado+n),diasTranscurridos:r,diasTotales:i});return{...a,mensaje:P(e,a)}}async function tt(){let e=await I();if(!e)return[];let t=(await O()).filter(e=>e.tipo===`variable`),n=[];for(let r of t)for(let t of e.semanaActual.numero>1?e.semanas:[]){if(t.fin>=e.hoy||t.numero>=e.semanaActual.numero||await Be(e.ciclo.id,r.id,t.numero))continue;let i=w(Ke(r.monto,t,e.totalDias)-await M(r.id,t.inicio,t.fin));i>.01&&n.push({cicloId:e.ciclo.id,origenId:r.id,nombre:r.nombre,semanaNumero:t.numero,sobrante:i})}return n}async function nt({cicloId:e,origenId:t,semanaNumero:n,sobrante:r,decision:i}){if(await Ve({cicloId:e,origenId:t,semanaNumero:n,sobrante:r,decision:i}),i===`ahorro`){let e=await h(),t=await e.get(`bolsillos`,`ahorro`);await e.put(`bolsillos`,{...t,saldoAcumulado:w(t.saldoAcumulado+r)})}}var rt={ahorro:e=>`Pasa ${C(e)} a tu cuenta de Ahorro`,imprevistos:e=>`Aparta ${C(e)} para Imprevistos`,gustos:e=>`Aparta ${C(e)} para Gustos`,reserva:e=>`Aparta ${C(e)} para Reserva`};async function it(){let[e,t]=await Promise.all([k(),T()]),n=[{id:`esenciales`,texto:`Aparta ${C(e)} para tus Esenciales (Internet, Comida, etc.)`},...t.map(e=>({id:e.id,texto:rt[e.id](e.monto)}))],r=document.createElement(`div`);r.className=`panel-fondo`,r.innerHTML=`
  ...
  `,document.body.appendChild(r);let i=r.querySelectorAll(`input[type="checkbox"]`),a=r.querySelector(`#btn-confirmar-cobro`);i.forEach(e=>{e.addEventListener(`change`,()=>{a.disabled=![...i].every(e=>e.checked)})}),r.querySelector(`#btn-cerrar-checklist`).addEventListener(`click`,()=>r.remove()),r.addEventListener(`click`,e=>{e.target===r&&r.remove()}),a.addEventListener(`click`,async()=>{a.disabled=!0,await ke(r.querySelector(`#input-fecha-cobro`).value||_()),r.remove(),await J()})}var at=[`#61e5c4`,`#61bee5`,`#6175e5`,`#9661e5`,`#df61e5`,`#e561a3`];function L(e){let t=0;for(let n=0;n<e.length;n++)t=t*31+e.charCodeAt(n)>>>0;return at[t%at.length]}var R=null;async function z(e){R=e;let[t,n,r]=await Promise.all([Re(),D(),Qe()]),i=new Map([...t.categorias,...t.bolsillos].map(e=>[e.id,e.gastado])),a=t.categorias.reduce((e,t)=>e+t.gastado,0)+t.bolsillos.reduce((e,t)=>e+t.gastado,0),o=r.enModoSeguimiento?[]:await tt(),s=r.conSemaforo.filter(e=>e.estado!==`verde`);e.innerHTML=`
    <div class="pantalla">
      <p class="eyebrow">${S(_())}</p>

      ${r.enModoSeguimiento?st():``}
      ${!r.enModoSeguimiento&&ot(r.infoCiclo)?ct():``}

      ${s.length>0?`<h3 style="margin-top:16px; margin-bottom:12px; font-size:16px;">Alertas</h3>${s.map(lt).join(``)}`:``}
      ...
      ${r.enModoSeguimiento?t.categorias.map(B).join(``):[...r.conSemaforo.filter(e=>e.tipo===`categoria`).map(e=>mt(e,i.get(e.id))),...r.sinSemaforo.categoriasFijas.map(e=>ht(e,i.get(e.id)||0))].join(``)}

      <h3 style="margin-top: 32px; margin-bottom: 12px; font-size: 18px;">Otros bolsillos</h3>
      ${r.enModoSeguimiento?t.bolsillos.filter(e=>e.id!==`ahorro`).map(B).join(``):[r.conSemaforo.filter(e=>e.tipo===`bolsillo`).map(e=>mt(e,i.get(e.id))),r.sinSemaforo.otrosBolsillos.map(e=>B({...e,gastado:i.get(e.id)||0}))].flat().join(``)}

      <h3 style="margin-top: 32px; margin-bottom: 12px; font-size: 18px;">Ahorro</h3>
      ${gt(t.bolsillos.find(e=>e.id===`ahorro`))}
    </div>
  `,_t(e,o)}function ot(e){return e.semanaActual.numero===e.semanas.length}function st(){return`
  ...
  `}var dt={amarillo:`Amarillo`,rojo:`Rojo`,pasado:`Excedido`,verde:`Verde`},ft={amarillo:`badge-amarillo`,rojo:`badge-rojo`,pasado:`badge-rojo`,verde:`badge-verde`},pt={amarillo:`es-amarillo`,rojo:`es-rojo`,pasado:`es-rojo`,verde:``};function mt(e,t){let n=e.presupuesto>0?Math.min(100,e.gastado/e.presupuesto*100):100,r=e.periodo===`semana`?`esta semana`:`este mes`,i=L(e.id),a=e.estado===`verde`?`es-identidad`:pt[e.estado];return`
    <div class="tarjeta-oscura" style="--color-identidad: ${i};">
      <div style="display:flex; justify-content:space-between; align-items:baseline;">
        ...
        <span class="badge ${ft[e.estado]}">${dt[e.estado]}</span>
      </div>
  ...
  `}function ht(e,t){let n=t>0;return`
  ...
  `}function _t(e,t){let n=e.querySelector(`#btn-ya-cobre`);n&&n.addEventListener(`click`,()=>it()),e.querySelectorAll(`[data-sobrante-ahorro]`).forEach(e=>{e.addEventListener(`click`,async()=>{let[n,r]=e.dataset.sobranteAhorro.split(`__`);await nt({...t.find(e=>e.origenId===n&&String(e.semanaNumero)===r),decision:`ahorro`}),await z(R)})}),e.querySelectorAll(`[data-sobrante-semana]`).forEach(e=>{e.addEventListener(`click`,async()=>{let[n,r]=e.dataset.sobranteSemana.split(`__`);await nt({...t.find(e=>e.origenId===n&&String(e.semanaNumero)===r),decision:`siguienteSemana`}),await z(R)})})}async function vt(e){let t=await O();e.innerHTML=`
    <div class="pantalla">
      <p class="eyebrow">Categorías esenciales</p>
      <p class="cifra-media" style="margin-top: 8px;">${C(t.reduce((e,t)=>e+t.monto,0))} / mes</p>

      <div style="margin-top: 24px;">
        ${t.map(yt).join(``)||`<p class="texto-tenue">Todavía no tienes categorías.</p>`}
      </div>
  ...
  `,e.querySelector(`#btn-nueva-categoria`).addEventListener(`click`,()=>bt(null)),e.querySelectorAll(`[data-editar]`).forEach(e=>{e.addEventListener(`click`,()=>{bt(t.find(t=>t.id===e.dataset.editar))})})}function yt(e){return`
    <div class="tarjeta-oscura" style="--color-identidad: ${L(e.id)};">
      <div style="display:flex; justify-content:space-between; align-items:baseline;">
        <span class="nombre-con-color"><span class="punto-identidad"></span>${e.nombre}</span>
  ...
  `}function bt(e){let t=e!==null,n=document.createElement(`div`);n.className=`panel-fondo`,n.innerHTML=`
    <div class="panel-hoja">
      <div class="panel-hoja__cabecera">
  ...
  `,document.body.appendChild(n),n.querySelector(`#btn-cerrar-form`).addEventListener(`click`,()=>n.remove()),n.addEventListener(`click`,e=>{e.target===n&&n.remove()}),n.querySelector(`#form-categoria`).addEventListener(`submit`,async r=>{r.preventDefault();let i={nombre:n.querySelector(`#campo-nombre`).value.trim(),monto:parseFloat(n.querySelector(`#campo-monto`).value)||0,tipo:n.querySelector(`input[name="tipo"]:checked`).value};t?await Me(e.id,i):await je(i),n.remove(),await J()});let r=n.querySelector(`#btn-borrar-categoria`);r&&r.addEventListener(`click`,async()=>{window.confirm(`¿Borrar la categoría "${e.nombre}"? Esto no se puede deshacer.`)&&(await Ne(e.id),n.remove(),await J())})}async function V(){return(await(await h()).getAll(`metas`)).sort((e,t)=>e.orden-t.orden)}async function xt(e){let t=await h(),n=await V(),r={id:g(),nombre:e.nombre,precioObjetivo:e.precioObjetivo,fechaObjetivo:e.fechaObjetivo||null,orden:n.length,creadaEn:Date.now()};return await t.put(`metas`,r),r}async function St(e,t){let n=await h(),r=await n.get(`metas`,e);if(!r)throw Error(`La meta no existe`);let i={...r,...t};return await n.put(`metas`,i),i}async function Ct(e){await(await h()).delete(`metas`,e)}async function wt(e,t){let n=await h(),r=await V(),i=r.findIndex(t=>t.id===e),a=t===`arriba`?i-1:i+1;if(i===-1||a<0||a>=r.length)return;let o=r[i].orden;r[i].orden=r[a].orden,r[a].orden=o,await n.put(`metas`,r[i]),await n.put(`metas`,r[a])}function Tt(e,t,n){let r=Math.max(e,0),i=0;return t.map(t=>{i=w(i+t.objetivo);let a=w(Math.min(r,t.objetivo));r=w(r-a);let o=w(Math.max(t.objetivo-a,0)),s=o<=0,c=w(Math.max(i-e,0)),l=s||n<=0?s?0:null:Math.ceil(c/n);return{id:t.id,objetivo:t.objetivo,asignado:a,faltante:o,completado:s,mesesEstimados:l}})}function Et(e,t){return t==null?null:ge(e,t)}var Dt=`fondo-emergencia`;async function Ot(){let[e,t,n]=await Promise.all([we(`ahorro`),k(),V()]),r=[{id:Dt,objetivo:t},...n.map(e=>({id:e.id,objetivo:e.precioObjetivo}))],i=Tt(e.saldoAcumulado,r,e.monto),a=_();return i.map(t=>{let r=t.id===Dt,i=r?null:n.find(e=>e.id===t.id),o=Et(a,t.mesesEstimados),s=null;return!r&&i?.fechaObjetivo&&o&&!t.completado&&(s=b(i.fechaObjetivo,o)<=0?`a-tiempo`:`atrasado`),{...t,esFondoEmergencia:r,nombre:r?`Fondo de emergencia`:i.nombre,fechaObjetivoUsuario:r?null:i.fechaObjetivo,fechaEstimada:o,comparacionFecha:s,ahorroMensual:e.monto}})}async function kt(e){let t=await Ot();e.innerHTML=`
    <div class="pantalla">
      ...
      <div style="margin-top: 24px;">
        ${t.map((e,n)=>At(e,n,t.length)).join(``)}
      </div>
  ...
  `,e.querySelector(`#btn-nueva-meta`).addEventListener(`click`,()=>jt(null)),e.querySelectorAll(`[data-editar-meta]`).forEach(e=>{e.addEventListener(`click`,()=>{jt(t.find(t=>t.id===e.dataset.editarMeta))})}),e.querySelectorAll(`[data-mover]`).forEach(e=>{e.addEventListener(`click`,async()=>{await wt(e.dataset.mover,e.dataset.direccion),await J()})})}function At(e,t,n){let r=e.objetivo>0?Math.min(100,e.asignado/e.objetivo*100):0,i=!e.esFondoEmergencia;return`
  ...
  `}function jt(e){let t=e!==null,n=document.createElement(`div`);n.className=`panel-fondo`,n.innerHTML=`
    <div class="panel-hoja">
      <div class="panel-hoja__cabecera">
  ...
  `,document.body.appendChild(n),n.querySelector(`#btn-cerrar-form`).addEventListener(`click`,()=>n.remove()),n.addEventListener(`click`,e=>{e.target===n&&n.remove()}),n.querySelector(`#form-meta`).addEventListener(`submit`,async r=>{r.preventDefault();let i={nombre:n.querySelector(`#campo-nombre`).value.trim(),precioObjetivo:parseFloat(n.querySelector(`#campo-precio`).value)||0,fechaObjetivo:n.querySelector(`#campo-fecha`).value||null};t?await St(e.id,i):await xt(i),n.remove(),await J()});let r=n.querySelector(`#btn-borrar-meta`);r&&r.addEventListener(`click`,async()=>{window.confirm(`¿Borrar la meta "${e.nombre}"? Esto no se puede deshacer.`)&&(await Ct(e.id),n.remove(),await J())})}async function Mt(){return(await Oe()).find(e=>e.fechaFin!==null)||null}async function Nt(e){let[t,n,r]=await Promise.all([O(),T(),Mt()]),i=[...t.map(e=>({id:e.id,nombre:e.nombre,monto:e.monto})),...n.filter(e=>e.id!==`ahorro`).map(e=>({id:e.id,nombre:e.nombre,monto:e.monto}))],a=await Promise.all(i.map(async t=>{let n=await M(t.id,e.ciclo.fechaInicio,_()),i=r?await M(t.id,r.fechaInicio,r.fechaFin):null,a=w(n-t.monto),o=i===null?null:w(n-i);return{...t,presupuestado:t.monto,real:n,anterior:i,sobregasto:a,delta:o}}));return a.sort((e,t)=>t.sobregasto-e.sobregasto),{filas:a,hayCicloAnterior:r!==null}}function Pt(e){let t=e.filter(e=>e.sobregasto>0).sort((e,t)=>t.sobregasto-e.sobregasto);if(t.length===0){let t=w(e.reduce((e,t)=>e+t.presupuestado,0)-e.reduce((e,t)=>e+t.real,0));return t>0?`Vas dentro de todos tus presupuestos. Te quedan ${C(t)} sin gastar este mes — considera pasarlos a tu Ahorro.`:`Vas dentro de todos tus presupuestos este mes. Sigue así.`}let n=t[0];return t.length===1?`Tu único sobregasto este mes es en ${n.nombre}: te pasaste por ${C(n.sobregasto)}. Revisa esa categoría la próxima semana.`:`Donde más te pasaste este mes es en ${n.nombre} (${C(n.sobregasto)} de más), seguido de ${t[1].nombre} (${C(t[1].sobregasto)} de más). Empieza por ahí.`}function Ft(e,t){let n=e.filter(e=>e.monto<t),r=w(n.reduce((e,t)=>e+t.monto,0)),i=w(r*12);return{cantidad:n.length,totalMes:r,proyeccionAnual:i}}var H=`mes`;async function It(e){let t=await I();if(!t){e.innerHTML=`
      <div class="pantalla">
    ...
    `;return}e.innerHTML=`<div class="pantalla" id="contenido-resumen"></div>`,await Lt(e.querySelector(`#contenido-resumen`),t)}async function Lt(e,t){e.innerHTML=`
    <p class="eyebrow">Resumen</p>
  ...
  `,e.querySelectorAll(`[data-vista]`).forEach(n=>{n.addEventListener(`click`,async()=>{H=n.dataset.vista,await Lt(e,t)})});let n=e.querySelector(`#cuerpo-resumen`);H===`semana`?await Rt(n,t):await zt(n,t)}async function Rt(e,t){let n=await Qe(),r=e=>e.gastado-e.presupuesto,i=[...n.conSemaforo].sort((e,t)=>r(t)-r(e));e.innerHTML=`
    ...
    ${i.map(e=>Bt(e.id,e.nombre,e.presupuesto,e.gastado)).join(``)}
  `}async function zt(e,t){let[{filas:n,hayCicloAnterior:r},i,a]=await Promise.all([Nt(t),D(),j({desde:t.ciclo.fechaInicio,hasta:_()})]),o=Pt(n),s=Ft(a,i.umbralHormiga);e.innerHTML=`
    <div class="alerta alerta-info">
    ...
    ${n.map(e=>Bt(e.id,e.nombre,e.presupuestado,e.real)).join(``)}

    ${r?Vt(n):``}

    ${Ut(s,i.umbralHormiga)}
  ...
  `}function Bt(e,t,n,r){let i=n>0?r/n:+(r>0),a=i>=1||i>=.9?`es-rojo`:i>=.75?`es-amarillo`:`es-identidad`,o=Math.min(100,i*100);return`
  ...
  `}function Vt(e){let t=e.filter(e=>e.anterior!==null);return t.length===0?``:`
    ...
    ${t.map(Ht).join(``)}
  `}function Ht(e){let t=Math.max(e.anterior,e.real,1)*1.15,n=e.anterior/t*100,r=e.real/t*100,i=Math.min(n,r),a=Math.abs(r-n),o=e.real>e.anterior,s=o?`var(--color-rojo)`:`var(--color-verde)`,c=e.delta>0?`+`:e.delta<0?`−`:``;return`
    <div class="tarjeta-oscura" style="--color-identidad: ${L(e.id)};">
      <div style="display:flex; justify-content:space-between; align-items:baseline;">
        <span class="nombre-con-color"><span class="punto-identidad"></span>${e.nombre}</span>
  ...
  `}function Ut(e,t){return e.cantidad===0?``:`
  ...
  `}function U({titulo:e,mensaje:t,claseAlerta:n=`alerta-info`,textoConfirmar:r=`Continuar`,textoCancelar:i=`Cancelar`}){return new Promise(a=>{let o=document.createElement(`div`);o.className=`panel-fondo`,o.innerHTML=`
      <div class="panel-hoja">
        <div class="alerta ${n}">
    ...
    `;let s=e=>{o.remove(),a(e)};o.querySelector(`#btn-confirmar`).addEventListener(`click`,()=>s(!0)),o.querySelector(`#btn-cancelar`).addEventListener(`click`,()=>s(!1)),o.addEventListener(`click`,e=>{e.target===o&&s(!1)}),document.body.appendChild(o)})}var W={busqueda:``,origenId:``,desde:``,hasta:``};async function G(e){let[t,n,r]=await Promise.all([j(),O(),T()]),i=[...n.map(e=>({...e,_origenTipo:`categoria`})),...r.map(e=>({...e,_origenTipo:`bolsillo`}))],a=new Map(i.map(e=>[e.id,e.nombre])),o=t.filter(e=>{let t=a.get(e.origenId)||``,n=!W.busqueda||e.nota.toLowerCase().includes(W.busqueda.toLowerCase())||t.toLowerCase().includes(W.busqueda.toLowerCase()),r=!W.origenId||e.origenId===W.origenId,i=!W.desde||e.fecha>=W.desde,o=!W.hasta||e.fecha<=W.hasta;return n&&r&&i&&o}),s=o.reduce((e,t)=>e+t.monto,0);e.innerHTML=`
    <div class="pantalla">
      <p class="eyebrow">Historial</p>

      <div class="campo" style="margin-top: 16px;">
        <input type="text" id="input-busqueda" placeholder="Buscar por nota o categoría" value="${W.busqueda}" />
      </div>

      <div class="campo">
        <select id="select-origen">
          <option value="">Todas las categorías y bolsillos</option>
          ${i.map(e=>`<option value="${e.id}" ${W.origenId===e.id?`selected`:``}>${e.nombre}</option>`).join(``)}
        </select>
      </div>
      ...
      <div style="display:flex; gap:8px;">
        <div class="campo" style="flex:1;">
          <label>Desde</label>
          <input type="date" id="input-desde" value="${W.desde}" />
        </div>
        <div class="campo" style="flex:1;">
          <label>Hasta</label>
          <input type="date" id="input-hasta" value="${W.hasta}" />
        </div>
      </div>
  ...
  `}function Gt(e,t){let n=document.createElement(`div`);n.className=`panel-fondo`,n.innerHTML=`
    <div class="panel-hoja">
      <div class="panel-hoja__cabecera">
        <h2>Editar gasto</h2>
        <button class="btn btn-fantasma" id="btn-cerrar-form" aria-label="Cerrar">✕</button>
  ...
  `,document.body.appendChild(n),n.querySelector(`#btn-cerrar-form`).addEventListener(`click`,()=>n.remove()),n.addEventListener(`click`,e=>{e.target===n&&n.remove()}),n.querySelector(`#form-transaccion`).addEventListener(`submit`,async r=>{r.preventDefault();let i=t.find(e=>e.id===n.querySelector(`#campo-origen`).value);(i.id!==`ahorro`||e.origenId===`ahorro`||await U({titulo:`Estás por tocar tu Ahorro`,mensaje:`Vas a mover este gasto para que salga de tu Ahorro. ¿Seguro?`,claseAlerta:`alerta-roja`,textoConfirmar:`Sí, mover a Ahorro`,textoCancelar:`Mejor no`}))&&(await Fe(e.id,{monto:parseFloat(n.querySelector(`#campo-monto`).value)||0,fecha:n.querySelector(`#campo-fecha`).value,nota:n.querySelector(`#campo-nota`).value.trim(),origenId:i.id,origenTipo:i._origenTipo}),n.remove(),await J())}),n.querySelector(`#btn-borrar-transaccion`).addEventListener(`click`,async()=>{window.confirm(`¿Borrar este gasto? Esto no se puede deshacer.`)&&(await Ie(e.id),n.remove(),await J())})}async function Kt(e){let[t,n,r]=await Promise.all([O(),D(),I()]),i=t.filter(e=>e.tipo===`fija`);e.innerHTML=`
    <div class="pantalla">
      ...
      <div style="margin-top: 20px;">
        ${i.map(qt).join(``)||`<p class="texto-tenue">No tienes categorías fijas todavía.</p>`}
      </div>
  ...
  `,e.querySelectorAll(`[data-borrar-suscripcion]`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.borrarSuscripcion,n=i.find(e=>e.id===t);window.confirm(`¿Borrar "${n.nombre}"? Esto cancela el seguimiento de este gasto fijo en la app.`)&&(await Ne(t),e.closest(`.tarjeta-oscura`).remove())})}),e.querySelector(`#btn-terminar-revision`).addEventListener(`click`,async()=>{r&&await Ae({ultimaRevisionSuscripcionesCicloId:r.ciclo.id}),window.location.hash=`#/resumen`})}function qt(e){return`
  ...
  `}var K=[`configuracion`,`categorias`,`bolsillos`,`transacciones`,`ciclos`,`cierresSemana`,`metas`],Jt=1;async function Yt(){let e=await h(),t={};for(let n of K)t[n]=await e.getAll(n);return{version:Jt,generadoEn:new Date().toISOString(),app:`finanzas-personales`,datos:t}}async function Xt(e){if(!e||typeof e!=`object`||!e.datos)throw Error(`El archivo no tiene el formato de un respaldo válido`);let t=(await h()).transaction(K,`readwrite`);for(let n of K){let r=t.objectStore(n);await r.clear();let i=e.datos[n]||[];for(let e of i)await r.put(e)}await t.done}function Zt(e,t,n){let r=new Blob([e],{type:n}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=t,document.body.appendChild(a),a.click(),a.remove(),URL.revokeObjectURL(i)}async function Qt(){let e=await Yt(),t=new Date().toISOString().slice(0,10);Zt(JSON.stringify(e,null,2),`respaldo-finanzas-${t}.json`,`application/json`)}function $t(e){let t=String(e??``);return t.includes(`,`)||t.includes(`"`)||t.includes(`
`)?`"${t.replace(/"/g,`""`)}"`:t}async function en(){let[e,t,n]=await Promise.all([j(),O(),T()]),r=new Map([...t,...n].map(e=>[e.id,e.nombre]));Zt(`﻿`+[[`Fecha`,`Categoria`,`Monto`,`Nota`],...e.map(e=>[S(e.fecha),r.get(e.origenId)||`Categoría eliminada`,C(e.monto),e.nota||``])].map(e=>e.map($t).join(`,`)).join(`\r
`),`historial-finanzas-${new Date().toISOString().slice(0,10)}.csv`,`text/csv;charset=utf-8`)}function tn(e){let t=document.getElementById(`aviso-flotante`);t&&t.remove();let n=document.createElement(`div`);n.id=`aviso-flotante`,n.className=`aviso-flotante`,n.textContent=e,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add(`visible`)),setTimeout(()=>{n.classList.remove(`visible`),setTimeout(()=>n.remove(),250)},1800)}async function nn(e){let[t,n,r,i]=await Promise.all([D(),T(),k(),De()]),a=r+n.reduce((e,t)=>e+t.monto,0),o=t.ingresoMensual-a;e.innerHTML=`
    <div class="pantalla">
  ...
  `;let s=e.querySelector(`#btn-confirmar-nuevo-cobro`);s&&s.addEventListener(`click`,()=>it()),e.querySelector(`#btn-descargar-respaldo`).addEventListener(`click`,()=>Qt()),e.querySelector(`#btn-exportar-csv`).addEventListener(`click`,()=>en()),e.querySelector(`#btn-reiniciar-todo`).addEventListener(`click`,async()=>{await U({titulo:`Vas a borrar TODO`,mensaje:`Se borran todos tus gastos, ciclos, metas y bolsillos acumulados. Las categorías vuelven a los valores de ejemplo. Esto no se puede deshacer.`,claseAlerta:`alerta-roja`,textoConfirmar:`Sí, quiero borrar todo`,textoCancelar:`Cancelar`})&&await U({titulo:`¿Estás totalmente seguro?`,mensaje:`Última confirmación: no hay forma de recuperar estos datos después, salvo que tengas un respaldo descargado.`,claseAlerta:`alerta-roja`,textoConfirmar:`Borrar todo definitivamente`,textoCancelar:`Mejor no`})&&(await Se(),window.location.hash=``,window.location.reload())});let c=e.querySelector(`#input-restaurar`);e.querySelector(`#btn-restaurar-respaldo`).addEventListener(`click`,()=>c.click()),c.addEventListener(`change`,async()=>{let e=c.files[0];if(!e)return;let t=await U({titulo:`Vas a reemplazar todos tus datos`,mensaje:`Se borrará todo lo que tienes ahora en la app y se reemplazará por lo que hay en "${e.name}". Esto no se puede deshacer.`,claseAlerta:`alerta-roja`,textoConfirmar:`Sí, restaurar este respaldo`,textoCancelar:`Cancelar`});if(c.value=``,t)try{let t=await e.text();await Xt(JSON.parse(t)),alert(`Respaldo restaurado. La app se va a recargar.`),window.location.hash=``,window.location.reload()}catch(e){alert(`No se pudo restaurar el respaldo: ${e.message}`)}}),e.querySelector(`#form-ajustes`).addEventListener(`submit`,async t=>{t.preventDefault(),await Ae({ingresoMensual:parseFloat(e.querySelector(`#campo-ingreso`).value)||0,diaCobroEsperado:parseInt(e.querySelector(`#campo-dia-cobro`).value,10)||1,umbralHormiga:parseFloat(e.querySelector(`#campo-umbral-hormiga`).value)||0});let n=e.querySelectorAll(`[data-bolsillo]`);for(let e of n)await Te(e.dataset.bolsillo,parseFloat(e.value)||0);await J(),tn(`Cambios guardados`)})}var rn=[{id:`hoy`,href:`#`,icono:`◆`,etiqueta:`Hoy`},{id:`categorias`,href:`#/categorias`,icono:`▤`,etiqueta:`Categorías`},{id:`metas`,href:`#/metas`,icono:`●`,etiqueta:`Metas`},{id:`resumen`,href:`#/resumen`,icono:`▲`,etiqueta:`Resumen`},{id:`ajustes`,href:`#/ajustes`,icono:`⚙`,etiqueta:`Ajustes`}];function an(e){let t=document.getElementById(`nav-inferior`);t&&(t.innerHTML=rn.map(t=>`
      <a
    ...
    `).join(``))}var on={"":{render:z,id:`hoy`},"#/categorias":{render:vt,id:`categorias`},"#/metas":{render:kt,id:`metas`},"#/resumen":{render:It,id:`resumen`},"#/historial":{render:G,id:`resumen`},"#/suscripciones":{render:Kt,id:`resumen`},"#/ajustes":{render:nn,id:`ajustes`}},sn;function cn(){return on[window.location.hash]||on[``]}async function q(){let e=cn();an(e.id),await e.render(sn)}async function J(){await q()}function ln(e){sn=e,window.addEventListener(`hashchange`,q),q()}var Y=`0`,X=null,Z=!1;function un(){return`$${Y}`}function dn(){return parseFloat(Y.replace(`,`,`.`))||0}function fn(){Y=`0`,X=null,Z=!1}async function pn(){fn();let e=await Re(),t=document.createElement(`div`);t.className=`panel-fondo`,t.innerHTML=`
    <div class="panel-hoja">
      <div class="panel-hoja__cabecera">
      ...
      <div class="monto-mostrado" id="monto-mostrado">${un()}</div>
  ...
  `,document.body.appendChild(t),vn(t)}function Q(e){e.remove()}var mn={amarillo:`alerta-amarilla`,rojo:`alerta-roja`,pasado:`alerta-roja`},hn={amarillo:`Vas rápido`,rojo:`Cuidado`,pasado:`Te vas a exceder`};async function gn(e){let t=await $e(X.tipo,X.id,e);return!t||t.estado===`verde`||U({titulo:hn[t.estado],mensaje:t.mensaje,claseAlerta:mn[t.estado],textoConfirmar:`Registrar de todas formas`,textoCancelar:`Mejor no`})}function $(e){let t=e.querySelector(`#btn-guardar-gasto`);t.disabled=!(dn()>0&&X!==null)}function _n(e,t){e.querySelectorAll(`.chip-categoria`).forEach(e=>e.classList.remove(`activo`)),t.classList.add(`activo`),X={tipo:t.dataset.tipo,id:t.dataset.id,nombre:t.dataset.nombre},Z=!1,$(e)}function vn(e){e.querySelector(`#btn-cerrar-registro`).addEventListener(`click`,()=>Q(e)),e.addEventListener(`click`,t=>{t.target===e&&Q(e)}),e.querySelector(`#teclado-numerico`).addEventListener(`click`,t=>{let n=t.target.closest(`button[data-tecla]`);if(!n)return;let r=n.dataset.tecla;if(r===`⌫`)Y=Y.length>1?Y.slice(0,-1):`0`;else if(r===`,`)Y.includes(`,`)||(Y+=`,`);else{let[,e]=Y.split(`,`);if(e!==void 0&&e.length>=2)return;Y=Y===`0`?r:Y+r}e.querySelector(`#monto-mostrado`).textContent=un(),$(e)}),e.querySelector(`#selector-origenes`).addEventListener(`click`,t=>{let n=t.target.closest(`.chip-categoria`);n&&_n(e,n)}),e.querySelector(`#btn-retirar-ahorro`).addEventListener(`click`,async()=>{await U({titulo:`Estás por tocar tu Ahorro`,mensaje:`Este dinero es tu fondo de emergencia y tus metas. ¿Seguro que quieres retirar de ahí?`,claseAlerta:`alerta-roja`,textoConfirmar:`Sí, retirar de mi Ahorro`,textoCancelar:`Mejor no`})&&(Z=!0,e.querySelectorAll(`.chip-categoria`).forEach(e=>e.classList.remove(`activo`)),X={tipo:`bolsillo`,id:`ahorro`,nombre:`Ahorro`},$(e))}),e.querySelector(`#btn-guardar-gasto`).addEventListener(`click`,async()=>{let t=e.querySelector(`#btn-guardar-gasto`);t.disabled=!0;let n=dn();if(!await gn(n)){t.disabled=!1;return}try{await Pe({monto:n,origenTipo:X.tipo,origenId:X.id,nota:e.querySelector(`#input-nota`).value.trim(),fecha:e.querySelector(`#input-fecha`).value||_(),confirmoRetiroAhorro:Z}),Q(e),await J()}catch(e){alert(`No se pudo guardar el gasto: ${e.message}`),t.disabled=!1}})}function yn(){let e=e=>e.preventDefault();document.addEventListener(`gesturestart`,e),document.addEventListener(`gesturechange`,e),document.addEventListener(`gestureend`,e)}async function bn(){yn(),await xe();let e=document.getElementById(`app`);e.innerHTML=`
    <main id="vista"></main>
    <button id="fab-registro" class="fab-registro" aria-label="Registrar gasto">+</button>
    <nav id="nav-inferior" class="nav-inferior"></nav>
  `,document.getElementById(`fab-registro`).addEventListener(`click`,pn),ln(document.getElementById(`vista`))}bn();